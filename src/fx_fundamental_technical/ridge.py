"""Small ridge solver with active-set non-negative feature constraints."""
...
class SingularModelError(ValueError):
    """Raised when even regularized normal equations cannot be solved."""
...
def ridge_fit(
    ...
    *,
    ...
    """Fit ridge coefficients, setting violated constrained slopes to zero."""
